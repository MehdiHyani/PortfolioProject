            ...
            <div className="third_container">
              ...
              <div className="contact">
                <Button
                  href={`${data.linkedIn}`}
                  startIcon={
                    window.screen.width > 577 ? <LinkedInIcon /> : <></>
                  }
                  style={
                    window.screen.width > 577
                      ? {
                ...
                <Button
                  href={`${data.github}`}
                  startIcon={window.screen.width > 577 ? <GitHubIcon /> : <></>}
                  style={
                    window.screen.width > 577
                      ? {
                          height: "70px",
                ...
                <Button
                  href={`${data.twitter}`}
                  startIcon={
                    window.screen.width > 577 ? <TwitterIcon /> : <></>
                  }
                  style={
                    window.screen.width > 577
                      ? {
                ...
                <Button
                  href={`${data.facebook}`}
                  startIcon={
                    window.screen.width > 577 ? <FacebookIcon /> : <></>
                  }
                  style={
                    window.screen.width > 577
                      ? {
